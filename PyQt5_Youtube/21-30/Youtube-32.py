...
class Window (QMainWindow):
    def __init__(self):
        ...
        printAction = QAction(QIcon("print.jpg"),'Print',self)
        printAction.setShortcut("Ctrl+P")
        printAction.triggered.connect(self.printDialog)
        fileMenu.addAction(printAction)

        printPreviewAction = QAction(QIcon("printpreview.jpg"),'Print Preview',self)
        printPreviewAction.triggered.connect(self.printPreviewDialog)
        fileMenu.addAction(printPreviewAction)

        pdfAction = QAction(QIcon("pdf.jpg"),'Export PDF',self)
        ...
        colorAction = QAction(QIcon("color.jpg"),"Color",self)
