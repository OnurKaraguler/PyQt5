...
class Main(QWidget):
    ...
    def layouts(self):
        ...
        self.mainLayout.addLayout((self.leftLayout),40)     # 40% space of the main layout
        self.mainLayout.addLayout(self.rightMainLayout,60)  # 40% space of the main layout
    ...
    def addEmployee(self):
        self.newEmployee = AddEmployee()        #Class name
        self.close()
    ...
    def singleClick(self):
        ...
        id = employee.split('-')[0]     #id no almak için
    ...
    def updateEmployee(self):
        ...
        if self.employeeList.selectedItems():
            ...
            self.updateWindow = UpdateEmployee()    #class
        else:
...
class UpdateEmployee(QWidget):
    ...
    def layouts(self):
        ...
        self.topLayout.addStretch()
        self.topLayout.setContentsMargins(120, 20, 10, 30)
        #############Bottom layout##################
